...
(use-package aggressive-indent
  ...
  :hook ((after-init . global-aggressive-indent-mode)
         ...
         ;; htps://github.com/Malabarba/aggressive-indent-mode/issues/73
         (find-file . (lambda ()
                        (when (vk/too-long-file-p)
...
(use-package beginend
  ...
  :config (mapc (lambda (pair) (diminish (cdr pair)))
                beginend-modes))
