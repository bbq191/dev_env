...
(setq vk-theme 'system)                           ; Color theme: system, default, pro, dark, light, warm, cold, day or night
...
(setq vk-tree-sitter nil)                        ; Enable tree-sitter or not: t or nil. Only available in 29+.
